...
function Contact() {
  const FORM_ENDPOINT = "https://public.herotofu.com/v1/64a77a20-8f7f-11ee-9fc3-0f51c88dc991"; // TODO - update to the correct endpoint
  ...
  return (
    <div className="container">
      ...
      <div className="leftSide"
       data-aos="fade-right"  data-aos-duration="1000" data-aos-easing="ease-in-sine" data-aos-once="true"
       >
        <h1>Let's Talk</h1>
        <p>
